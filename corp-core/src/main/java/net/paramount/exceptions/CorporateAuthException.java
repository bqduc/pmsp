...
public class CorporateAuthException extends AuthenticationException/*RuntimeException*/ {
   ...
   */
  public CorporateAuthException(String message) {
      super(message);
  }
   ...
   * @since  1.4
   */
  public CorporateAuthException(String message, Throwable cause) {
      super(message, cause);
  }
   ...
   * @since  1.4
   */
  public CorporateAuthException(Throwable cause) {
      super("", cause);
  }
   ...
   * @since 1.7
   */
  protected CorporateAuthException(String message, Throwable cause,
