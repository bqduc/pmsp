...
/**
 * The class {@code CommunicatorException} and its subclasses are a form of
 * {@code Throwable} that indicates conditions that a reasonable
 * application might want to catch.
 *
 * <p>The class {@code CommunicatorException} and any subclasses that are not also
...
public class CommunicatorException extends Exception {
   ...
   * @since 1.7
   */
  protected CommunicatorException(String message, Throwable cause,
