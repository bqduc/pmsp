...
public interface CommonConstants {
	...
	final static String SEARCH_SHELVES_QUERY = "from Shelf sh where (lower(sh.name) like :name or lower(sh.info) like :name) ";
	...
	final static String SEARCH_IMAGE_QUERY = "from Image i where (lower(i.name) like :name or lower(i.info) like :name or lower(i.cameraModel) like :name) ";
	...
	final static String SEARCH_ALBUM_QUERY = "from Album a where (lower(a.name) like :name or lower(a.info) like :name)";
	...
	final static String PARAM_OPERATION = "operation";
	final static String PARAM_DATA = "data";
