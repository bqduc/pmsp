...
@Service(value="dashletConverter")
public class DashletConverter implements Converter<Dashlet> {
	@Inject
	private DashletService service;

	public Dashlet getAsObject(FacesContext fc, UIComponent uic, String value) {
		Dashlet asObject = null;
	...
	public String getAsString(FacesContext fc, UIComponent uic, Dashlet object) {
		if (object != null) {
