...
@ViewScoped
public class InventoryProfileController extends BaseController {
	/**
	* 
	*/
	...
	private List<InventoryProfile> listOfEntities;
  ...
  public void doPostConstruct() {
		...
		listOfEntities = inventoryProfileService.getObjects();
