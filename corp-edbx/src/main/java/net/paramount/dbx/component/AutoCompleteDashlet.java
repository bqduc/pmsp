...
@Named(value="autoCompleteDashlet")
@ViewScoped
public class AutoCompleteDashlet implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6918123168553980539L;
